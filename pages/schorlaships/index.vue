  ...
  <v-container style="position: sticky; top: 0;">
    ...
    <v-row justify="center" align="center" style="height: 50vh;">
      ...
      <v-col cols="12" sm="8" md="12">
        ...
        <Useropportunities :title="'Schorlaships/Bursaries'" :opportunities="filteredOpps" :cdfbanner="cdfSelected" :home="consHome" v-else></Useropportunities>
...
onMounted(async () => {
  ...
  const { data: userConstituency, promise, pending } = useDocument(doc(collection(db, 'residential_home_details'), `${user.value?.uid}`))
