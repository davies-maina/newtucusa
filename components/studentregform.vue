...
async function nextStep (values: any) {
 if (currentStep.value === 1) {
  ...
  await setUserDocument('personal_details', values)
 ...
 if (currentStep.value === 2) {
  ...
  await setUserDocument('school_details', vals)
  await setUserDocument('form_current_step', {
    currentstep: currentStep.value + 1
  })
  buttonIsLoading.value = false
 ...
 if (currentStep.value === 3) {
  ...
  await setUserDocument('residential_home_details', vals)
  await setUserDocument('form_current_step', {
    currentstep: 0
  })
